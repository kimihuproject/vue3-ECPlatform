export default {
  ...
  //２ 版型
  template: `
  <div class="modal fade" id="orderInfoModal" tabindex="-1" aria-labelledby="orderInfoModal"
  aria-hidden="true">
 <div class="modal-dialog modal-dialog-centered modal-lg">
     <div class="modal-content">
         <div class="modal-header">
             <h1 class="modal-title fs-5" id="exampleModalLabel">訂單明細：{{orderData.id}}
             </h1>
                         ...
                         <div class="card">
                             <div class="card-body">
                                 <table class="table align-middle">
                                     ...
                                     <tbody>
                                         <tr v-for="cartItem in orderData.productsData" :key="'orderProducts'
                                             + cartItem.id">
                             ...
                             <div class="card-body">
                                 <table class="table align-middle">
                                     <tbody>
                                         ...
                                         <tr>
                                             <th scope="row">備註</th>
                                             <td>{{ orderData.user.message?orderData.user.message :'無備註'}}</td>
                                         </tr>
                                     </tbody>
                                 </table>
                             </div>
         ...
         <div class="modal-footer">
             ...
             <button type="button" class="btn btn-warning" @click="payOrder(orderData.id)"
                     :disabled="orderData.is_paid">
                 {{orderData.is_paid ? "已完成付款":"付款"}}</button>
         </div>
     </div>
 </div>
</div>
