          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="mb-3">
                ...
                <img class="img-fluid rounded" :src="productSelected.imageUrl" />
              ...
              >
                ...
                >
                  ...
                  <!-- 刪除該張照片選項： 該筆有內容時-->
                  <button
                    v-if="productSelected.imagesUrl[productSelected.imagesUrl.length - 1]"
                ...
                <div v-if="productSelected.imagesUrl[productSelected.imagesUrl.length - 1]">
                  <button
